                ...
                <div class="categories"><a href="index.php?act=themphim" class="product">Thêm Phim</a></div></div></div>
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            ...
                            $thuhoiBtn = '';
                            if (($role ?? -1) == ROLE_QUAN_LY_CUM) {
                                $thuhoiBtn = '<a class="button button-box button-xs button-warning" href="index.php?act=thuhoi_phim&id='.$id.'" onclick="return confirm(\'Thu hồi phim này khỏi tất cả rạp?\')" title="Thu hồi khỏi tất cả rạp"><i class="zmdi zmdi-undo"></i></a>';
                            }
