...
if (!function_exists('permission_map')) {
    ...
    function permission_map()
    {
        ...
        // 3 New Admin Features: Incident management, Advanced Analytics, and Autopilot Showtimes
        'QLsuco'              => [ROLE_ADMIN_HE_THONG, ROLE_QUAN_LY_CUM, ROLE_QUAN_LY_RAP],
        'baocao_analytics'    => [ROLE_ADMIN_HE_THONG, ROLE_QUAN_LY_CUM, ROLE_QUAN_LY_RAP],
        'autopilot_showtimes' => [ROLE_ADMIN_HE_THONG, ROLE_QUAN_LY_CUM, ROLE_QUAN_LY_RAP],
