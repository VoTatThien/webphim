...
// Thêm tài khoản mới
function insert_taikhoan($email, $user, $pass, $name, $sdt, $dc, $ngay_sinh = null, $gioi_tinh = null, $khoang_tuoi = null) {
    // Đăng ký khách hàng thành viên (vai_tro = 0)
    $sql = "INSERT INTO taikhoan (email, user, pass, dia_chi, phone, name, vai_tro, id_rap, img, ngay_sinh, gioi_tinh, khoang_tuoi) 
            VALUES (?, ?, ?, ?, ?, ?, 0, NULL, '', ?, ?, ?)";
    pdo_execute($sql, $email, $user, $pass, $dc, $sdt, $name, $ngay_sinh, $gioi_tinh, $khoang_tuoi);
}
