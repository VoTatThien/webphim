            ...
            <div class="auth-form-outer">
                ...
                <form class="login-form" method="post" action="index.php?act=dangky">
                    ...
                    <div style="margin-bottom: 15px; text-align: left;">
                        <label style="color: #666; font-size: 13px; font-weight: 600; display: block; margin-bottom: 5px;"><?= __('Khoảng tuổi') ?></label>
                        <select class="auth-form-input" name="khoang_tuoi" required style="margin-bottom: 0; padding: 10px 15px; border-radius: 4px; border: 1px solid #ddd; width: 100%; display: block; background: #fff; color: #333; appearance: auto;">
                            <option value=""><?= __('-- Chọn khoảng tuổi --') ?></option>
                            <option value="duoi_18"><?= __('Dưới 18 tuổi') ?></option>
                            <option value="18_25"><?= __('18 - 25 tuổi') ?></option>
                            <option value="26_35"><?= __('26 - 35 tuổi') ?></option>
                            <option value="36_45"><?= __('36 - 45 tuổi') ?></option>
                            <option value="tren_45"><?= __('Trên 45 tuổi') ?></option>
                        </select>
                    </div>
