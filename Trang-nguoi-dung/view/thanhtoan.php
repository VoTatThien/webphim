                ...
                <div class="promo-section">
                    ...
                    <?php if (!$diem_doi && (int)($_SESSION['user']['diem_tich_luy'] ?? 0) >= 1000): ?>
                        <div style="margin-top: 8px; display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                            ...
                            <button type="button" onclick="document.getElementById('so_diem_doi_input').value = <?= (int)$_SESSION['user']['diem_tich_luy'] ?>;" 
                            ...
                            <button type="button" onclick="document.getElementById('so_diem_doi_input').value = 1000;" 
